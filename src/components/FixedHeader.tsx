              ...
              <div className="flex items-center gap-3">
                {authenticated && user ? (
                  <div className="relative group">
                    <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all">
                    ...
                    <div className="absolute right-0 top-full mt-2 w-64 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none group-hover:pointer-events-auto">
                      <div className="bg-gray-900 border border-gray-800 rounded-xl shadow-2xl p-4">
                        ...
                        <div className="text-sm font-medium text-white mb-4 break-all">
                          {user.email?.address}
                        </div>
                        <button
                          onClick={logout}
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white text-sm font-medium transition-all"
                  >
                    Login / Sign Up
